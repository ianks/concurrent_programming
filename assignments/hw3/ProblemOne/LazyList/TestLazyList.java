public class TestLazyList implements Runnable {
	public final int me;
	public final String type;
	public static final int countToThis = 1000;
	public static final int threadCount = 16;
	public static LazyList<Integer> list;

	public TestLazyList(int newMe, String newType) {
		me = newMe;
		type = newType;
	}
	...
	public static void spawnThreads(String type) {
		...
		for (int i = 0; i < threadCount; i++) {
			threads[i] = new Thread(new TestLazyList(i, type));
			threads[i].start();
		}
